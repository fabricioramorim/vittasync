    ...
    <div class="py-12">
        ...
        <div class="grid grid-cols-3 gap-8 max-w-7xl mx-auto sm:px-6 lg:px-8 mt-8">
            ...
            <div class="flex justify-between mb-5">
                <div>
                <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">$12,423</h5>
                <p class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Sales this week</p>
                </div>
                <div
